...
def card_dealer_main():
    
    deck = create_deck()
    
    deal = int(input('How many cards would you like to deal? '))
    print()
    
    deal_cards(deck, deal)
...
def deal_cards(deck, deal):
    ...
    print()
    print('The total value of your hand is:', hand)